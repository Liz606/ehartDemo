        ...
        <Layout>
          ...
          >
            <Menu theme="light" defaultSelectedKeys={['1']} mode="inline">
              <SubMenu key="line" title={<span><Icon type="line-chart" /><span>Navigation One</span></span>}>
                <Menu.Item key="1"><IndexLink to="/bar">Option 1</IndexLink></Menu.Item>
                <Menu.Item key="2"><IndexLink to="/bar">Option 1</IndexLink></Menu.Item>
                <Menu.Item key="3"> <IndexLink to="/bar">Option 1</IndexLink></Menu.Item>
                <Menu.Item key="4"> <IndexLink to="/bar">Option 1</IndexLink></Menu.Item>
              </SubMenu>
              <SubMenu key="bar" title={<span><Icon type="bar-chart" /><span>Navigation Two</span></span>}>
                <Menu.Item key="5"> <IndexLink to="/bar">Option 1</IndexLink></Menu.Item>
                <Menu.Item key="6"> <IndexLink to="/bar">Option 1</IndexLink></Menu.Item>
              </SubMenu>
